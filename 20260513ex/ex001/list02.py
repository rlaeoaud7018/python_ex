...
# 오름차순(ASC)
numbers.sort()  #  == reverse = False(오름차순 설정이 이미 되어 있음)
print(f'numbers:{numbers}')     # [1, 2, 2, 3, 4, 5, 6]

# 내림차순(DESC)
numbers.sort(reverse = True)
print(f'numbers:{numbers}')     # [6, 5, 4, 3, 2, 2, 1]
...
names.sort()
print(f'names: {names}')       # ['김길동', '박길동', '이길동', '정길동', '홍길동']
names.sort(reverse=True)
print(f'names: {names}')       # ['홍길동', '정길동', '이길동', '박길동', '김길동']
...
# 인덱스 0부터 2까지의(3-1) 아이템을 슬라이싱.!

print(f'animals[3:]: {animals[3:]}')  # ['여우', '늑대']
# 인덱스 3부터 끝가지 아이템을 슬라이싱
...
# 인덱스 0부터 4까지의 아이템을 출력하시오.
print(f'{alphabet[:5]}')        # ['c', 'd', 'e', 'f']

# 인덱스 3부터 7까지의 아이템을 출력하시오.
print(f'{alphabet[3:8]}')       # ['d', 'e', 'f', 'g', 'h']

# 인덱스 5부터 끝까지의 아이템을 출력하시오.
print(f'{alphabet[6:]}')        # ['g', 'h', 'i', 'j']

# 뒤에서 4개 아이템을 출력하시오.
print(f'{alphabet[len(alphabet)-4:]}')    # print(f'{alphabet[-4:]}')
print(f'{alphabet[-4:]}')                 # print(f'{alphabet[-4:]}')
